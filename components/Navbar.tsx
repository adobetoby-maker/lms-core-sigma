...
import { LayoutDashboard, Settings, ShieldCheck, Users, FileText, ClipboardList, Users2, CalendarDays } from 'lucide-react'
            ...
            {profile?.is_admin ? (
              <>
                {[
                  ...
                  { href: '/admin/work-plans',   label: 'Work Plans',  Icon: CalendarDays },
